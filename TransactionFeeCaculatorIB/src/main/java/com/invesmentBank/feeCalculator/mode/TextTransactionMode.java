...
public class TextTransactionMode extends AbstractTransaction implements TransactionInterface {
	...
	public void readTransaction(File transactionFile) {
		...
		log.info("Read Transaction for text file");		
	...
	public TransactionInterface readFile(TRANSACTIONFILETYPES fileType) {
		...
		if(fileType == TRANSACTIONFILETYPES.TEXT){
			return TransactionModeFactory.getTrasactionModeInstance().readTextFile();
		}
		return null;
	}
